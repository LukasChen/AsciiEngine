...
void PhysicsSystem::resolveCollision(Rigidbody& rb1, Transform& t1, Collider& col1, Rigidbody& rb2, Transform& t2, Collider& col2) {
    ...
    Logger::log("Collision detected with penetration: " + pen.toString());
    ...
    if (pen.x <= pen.y && pen.x <= pen.z) {
        ...
        Logger::log("Resolving collision on X axis with move: " + std::to_string(move * dir));
        ...
        Logger::log("Resolving collision on Y axis with move: " + std::to_string(move * dir));
    } else {
        ...
        Logger::log("Resolving collision on Z axis with move: " + std::to_string(move * dir));
    }
}